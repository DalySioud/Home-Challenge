# Task 2: SSL Proxy Monitoring

The full answer to the monitoring questions is in [MONITORING.md](./MONITORING.md).
...
```
task2/
├── MONITORING.md              # The actual answer (metrics, how, challenges)
├── setup/
